...
[上一篇](https://mobilesite.github.io/2018/03/03/blockchain-practice-1/)中，介绍了一些区块链前端开发必知必会的基本概念以及区块链前端开发与传统业务前端开发的区别。这篇开始，我们将进入实战环节。跟做任何开发一样，区块链前端开发，首先也要搭建区块链的开发环境。下面将以Windows系统为例进行讲解。
