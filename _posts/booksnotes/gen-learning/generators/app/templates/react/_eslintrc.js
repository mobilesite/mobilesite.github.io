...
module.exports = {
    ...
    "rules": {
        ...
        "no-extra-boolean-cast": 1, // disallow double-negation boolean casts(转换) in a boolean context
        /* Best Practices */
        "accessor-pairs": [2, {"getWithoutSet": false}], // Enforces getter/setter pairs in objects
        "array-callback-return": 0, // Enforces return statements in callbacks of array's methods ??
        "block-scoped-var": 2, // treat var statements as if they were block scoped
        "curly": 2, // specify curly brace(大括号) conventions for all control statements
        "default-case": 2, // require default case in switch statements
        "dot-location": [2, "property"], // enforces consistent newlines before or after dots
        "dot-notation": 2, // encourages use of dot notation(符号) whenever possible
        ...
        "no-labels": 2, // disallow use of labeled statements(标号语句) ??
        "no-lone-blocks": 2, // disallow unnecessary nested(嵌套的) blocks
        ...
        "object-shorthand": 2, // require method and property shorthand syntax for object literals(对象字面量)
        ...
        "comma-spacing": 2, // enforce spacing before and after comma(逗号)
